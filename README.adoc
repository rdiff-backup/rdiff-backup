...
==== More complex ways for RHEL, CentOS (Stream), etc
...
----
<1> `python3-pyxattr` isn't available from EPEL 10, check the PyPi method if you need support for extended attributes.

.CentOS (Stream) and RHEL 9 & 10 (from PyPi)
[source,shell]
----
...
==== More complex ways for Debian, Ubuntu, etc
