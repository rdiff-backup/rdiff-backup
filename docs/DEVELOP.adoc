...
* `APT_DNF_ZYPPER` is a placeholder for whatever package manager is used on your Linux version, and you have the necessary access rights to call it via `sudo` (`sudo pacman -S ...` is also fine, or whatever).
