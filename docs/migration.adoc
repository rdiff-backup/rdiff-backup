...
| Display average of session statistics
| `+rdiff-backup calculate --method average {statistic_files...}+`
| `+rdiff-backup calculate average {statistic_files...}+`

| Display session and file statistics of a repository
| `+rdiff-backup-statistics --begin-time {datetime} --end-time {datetime} --minimum-ratio {ratio} {backup-repo}+`
| `+rdiff-backup calculate statistics --begin-time {datetime} --end-time {datetime} --minimum-ratio {ratio} {backup-repo}+`

| Remove a single file from a repository
| `+rdiff-backup-delete {backup-repo}/{path-to-file}+`
| `+rdiff-backup remove file {backup-repo}/{path-to-file}+`
