= image:resources/logo-banner.svg[rdiff-backup] rdiff-backup
:sectnums:
:toc: macro
...
* Installation instructions are directly available from our https://github.com/rdiff-backup/rdiff-backup#1-installation[GitHub site]
