"""
Test the basic backup and restore actions
"""
    ...
    def test_action_backuprestore_quoted(self):
        ...
        self.assertEqual(
            comtst.rdiff_backup_action(
                ...
                ("--current-time", "10000", "--chars-to-quote", "A:"),
                b"backup",
                (),
            ),
            0,
    ...
    def test_pre_quoted_files(self):
        ...
        self.assertEqual(
            comtst.rdiff_backup_action(
                ...
                self.bak_path,
                # colon quoted for Windows compatibility
                ("--current-time", "10000", "--chars-to-quote", "A-Z:"),
                b"backup",
                (),
            ),
            0,
        ...
        self.assertEqual(
            comtst.rdiff_backup_action(
                ...
                self.bak_path,
                # colon quoted for Windows compatibility
                ("--current-time", "20000", "--chars-to-quote", "A-Z:"),
                b"backup",
                (),
            ),
            0,
