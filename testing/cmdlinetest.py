...
class PathSetter(unittest.TestCase):
    ...
    def runtest(self, from_local, to_local):
        ...
        rdiff_backup(
            ...
            extra_options=b"restore --at 25000",
        )
        ...
        nochange_incs = len(
            self.getinc_paths(
                b"",
                os.path.join(
                    Local.rpout.path, b"rdiff-backup-data", b"increments", b"nochange"
                ),
            )
        )
...
class Final(PathSetter):
    ...
    def testWindowsMode(self):
        ...
        self.rb_schema = old_schema + b" --chars-to-quote '^a-z0-9_ -.' "
    ...
    @unittest.skipIf(os.name == "nt", "Windows doesn't recognize case insensitivity")
    def testLegacy(self):
...
class FinalMisc(PathSetter):
    ...
    def testListIncrementsLocal(self):
        ...
        rdiff_backup(
            True, True, Local.backup3rp.path, None, extra_options=b"list increments"
        )

    def testListIncrementsRemote(self):
        """Test --list-increments mode remotely.  Uses restoretest3"""
        rdiff_backup(
            False, True, Local.backup3rp.path, None, extra_options=b"list increments"
        )
    ...
    def testListChangeSinceLocal(self):
        ...
        rdiff_backup(
            ...
            None,
            extra_options=b"list files --changed-since 10000",
        )
        rdiff_backup(
            True,
            True,
            Local.backup3rp.path,
            None,
            extra_options=b"list files --changed-since 2B",
        )
    ...
    def testListAtTimeLocal(self):
        ...
        rdiff_backup(
            ...
            Local.backup3rp.path,
            None,
            extra_options=b"list files --at 20000",
        )
    ...
    def testListIncrementSizesLocal(self):
        ...
        rdiff_backup(
            ...
            Local.backup3rp.path,
            None,
            extra_options=b"list increments --size",
        )
    ...
    def testRemoveOlderThan(self):
        ...
        rdiff_backup(
            ...
            Local.rpout.path,
            None,
            extra_options=b"remove increments --older-than 20000",
        )
    ...
    def testRemoveOlderThan2(self):
        ...
        rdiff_backup(
            ...
            Local.rpout.path,
            None,
            extra_options=b"--force remove increments --older-than 1B",
        )
        rbdir = Local.rpout.append("rdiff-backup-data")
        for inc in self.get_all_increments(rbdir):
    ...
    def testRemoveOlderThanCurrent(self):
        ...
        rdiff_backup(
            ...
            Local.rpout.path,
            None,
            extra_options=b"--force remove increments " b"--older-than now",
        )
        rbdir = Local.rpout.append("rdiff-backup-data")
    ...
    def testRemoveOlderThanQuoting(self):
        ...
        rdiff_backup(
            ...
            Local.rpout.path,
            current_time=1000,
            extra_options=b"--chars-to-quote '^a-z0-9_ -.' backup",
        )
        rdiff_backup(
            True,
            True,
        ...
        rdiff_backup(
            ...
            Local.rpout.path,
            None,
            extra_options=b"remove increments --older-than now",
        )
    ...
    def testNonExistingTempDir(self):
        ...
        rdiff_backup(
            ...
            Local.vftrp.path,
            Local.rpout.path,
            extra_options=b"--tempdir DoesSurelyNotExist backup",
...
class FinalSelection(PathSetter):
    ...
    def testSelLocal(self):
        ...
        rdiff_backup(
            ...
            out_rel,
            current_time=10000,
            extra_options=b"backup --include %b --exclude '**' "
            % os.path.join(inc2_rel, b"various_file_types"),
        )

        # check that one included file exists and one excluded doesn't
        self.assertTrue(
            os.lstat(os.path.join(out_rel, b"various_file_types", b"regular_file"))
        )
        ...
        rdiff_backup(
            ...
            out_rel,
            current_time=20000,
            extra_options=b"backup " b"--include-filelist-stdin --exclude '**'",
            input=b"\n%b\n%b"
            % (
                os.path.join(inc2_rel, b"test.py"),
        ...
        self.assertRaises(
            OSError, os.lstat, os.path.join(out_rel, b"various_file_types")
        )
        self.assertRaises(
            OSError, os.lstat, os.path.join(out_rel, b"changed_dir", b"foo")
        )
        ...
        rdiff_backup(
            ...
            restore_filename,
            rest1_rel,
            extra_options=b"restore " b"--include-filelist-stdin --exclude '**'",
            input=b"\n%b"
            % os.path.join(rest1_rel, b"various_file_types", b"regular_file"),
        )

        self.assertTrue(
            os.lstat(os.path.join(rest1_rel, b"various_file_types", b"regular_file"))
        )
    ...
    def testSelFilesRemote(self):
        ...
        rdiff_backup(
            ...
            b"--exclude-filelist %b --include-filelist %b "
    ...
    def run_sel_restore_test(self, source_local, dest_local):
        ...
        excludes = b"--exclude %b --exclude %b" % (
            file1_target.path,
            existing_file.path,
        )
        rdiff_backup(
            ...
            Local.rpout.path,
            Local.rpout1.path,
            extra_options=b"--force restore --at now " + excludes,
...
class FinalBugs(PathSetter):
    ...
    def test_symlink_popple(self):
        ...
        # Make failed backup
        rbdir = Local.rpout.append("rdiff-backup-data")
        curmir = rbdir.append("current_mirror.%s.data" % (Time.timetostring(30000),))
        curmir.touch()
